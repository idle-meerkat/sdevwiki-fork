...
**NOTE**: The driver does not support all parameters. See [Supported Actions and Keys](#supported-actions-and-keys) [Supported Actions and Keys][] section in this document to know what exactly parameters are 