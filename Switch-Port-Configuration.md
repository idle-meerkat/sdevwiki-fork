...
If auto negotiation is enabled, the driver verifies inbound advertising modes and print an error message in the case of an unsupported mode. If auto-negotiation is disabled, the driver ignores the advertising mode setting.    
